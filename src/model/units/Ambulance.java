...
public class Ambulance extends MedicalUnit {
	...
	public void respond (Rescuable r) throws CannotTreatException, IncompatibleTargetException {		
		if (!(r instanceof Citizen))
			throw new IncompatibleTargetException(this, r, "You cannot heal a building (ambulance)");
		if (!this.canTreat(r))
			throw new CannotTreatException(this, r ,"The citizen is already safe");
		if ( !(r.getDisaster() instanceof Injury))
			throw new CannotTreatException(this, r ,"The Ambulance cannot heal an infection");
